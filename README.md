...
This application allows people to list their private driveways for a small fee to travelling campervan users looking for cheaper, more relaxed alternatives to traditional campsites. In the scope of the project, I have designed a view system for all listings by small cards or by a map function, a booking system and a minimal messaging system. This allows driveway owners to accept or decline bookings and communicate with campervan owners to organise payment and provide further contact details outside of the application. This application does not take payment for the reserved stays. 

## Designing User Stories

I based my user stories both from the view of a driveway owner and a campervan user:

1. As a user I can create an account so that I can browse listings as a traveller or upload a new listing as an owner.
...
2. As a traveller, I want to switch to a list view so that I can compare driveways by price, facilities, and reviews.
...
3. User Story: As a driveway owner, I want to upload multiple driveway spots so that I can list all the spaces I have available.
...
4. User Story: As a driveway owner, I want to specify facilities and stay rules so that travellers know what to expect.
...
5. User Story: As a traveller, I want to book a stay directly through the app so that I can secure a driveway spot for my campervan.
...
6. User Story: As a traveller, I want to browse driveways on a map so that I can quickly find suitable places near my route.
...
7. User Story: As a traveller, I want to see reviews on each driveway’s main page so that I can judge whether the spot is trustworthy and comfortable.
...
8. User Story: As a traveller, I want to leave a review after my stay so that I can share my experience.
